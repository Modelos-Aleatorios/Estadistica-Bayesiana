...
{\displaystyle \int \left( \frac{1}{\sqrt{2\pi}\sigma} \right)^{2n} e^{-\frac{1}{2\sigma^2} n \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]}\pi_\mu(\mu) \pi_\sigma(\sigma^2) d\sigma^2\ d\mu}\\
...
{\displaystyle \int \frac{1}{\sigma^{2n}} e^{-\frac{1}{2\sigma^2} n \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]}1 \frac{1}{\sigma^2} d\sigma^2\ d\mu}\\
...
{\displaystyle \int \frac{1}{\sigma^{2(n+1)}} e^{-\frac{1}{2\sigma^2} n \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]} d\sigma^2\ d\mu}
\end{array}
$$
...
\begin{array}{rl}
& \displaystyle \int \frac{1}{\sigma^{2(n+1)}} e^{-\frac{1}{2\sigma^2} n \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]} d\sigma^2\ d\mu\\
& = \displaystyle \int \int \frac{1}{\sigma^{2(n+1)}}e^{-\frac{1}{\sigma^2} A} d\sigma^2 d\mu\\
& = \displaystyle \int\int u^{n-1}e^{-uA}\frac{A^{n}}{\Gamma(n)}\frac{\Gamma(n)}{A^{n}} d\sigma^2 d\mu\\
& = \displaystyle \int\frac{\Gamma(n)}{A^{n}}\int u^{n-1}e^{-uA}\frac{A^{n}}{\Gamma(n)} d\sigma^2 d\mu\\
& = \displaystyle \int \Gamma(n)A^{-n}d\mu\\ 
& = \displaystyle \int \Gamma(n)\left(\frac{n \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]}{2}\right)^{-n}d\mu\\
& = \Gamma(n) n^{-n}2^n\displaystyle \int \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]^{-n}d\mu\\
\end{array}
$$
...
$$
\begin{array}{rl}
B_{10}^\pi = & \frac{\displaystyle \Gamma(n)2^{n}n^{-n} \int \frac{e^{-\frac{\xi^2}{2}}}{\sqrt{2\pi}} \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]^{-n} d\mu \ d\xi}{\Gamma(n) n^{-n}2^n\displaystyle \int \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]^{-n}d\mu}\\ 
B_{10}^\pi = & \frac{\displaystyle  \int \frac{e^{-\frac{\xi^2}{2}}}{\sqrt{2\pi}} \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]^{-n} d\mu \ d\xi}{\displaystyle \int \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]^{-n}d\mu} 
\end{array}
$$
...
$$
B_{01}^\pi = \frac{\displaystyle \int \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]^{-n}d\mu}{\displaystyle  \int \frac{e^{-\frac{\xi^2}{2}}}{\sqrt{2\pi}} \left[ S^2 + (\bar{x}-\mu+\epsilon)^2 +(\bar{y}-\mu-\epsilon)^2\right]^{-n} d\mu \ d\xi} 
$$
$OJOOOOO-NO- PUEDO- LLEGAR -A -LA -INTEGRAL- DEL- LIBRO$
